# Feishu-Claude Bridge v1.2 — Setup Script
...
if ($Help) {
    Write-Host @"
Feishu-Claude Bridge v1.2 — Setup
...
v1.2 New Features:
  - Thread-isolated conversation context (per-thread history)
  - Dynamic character-budget trimming (max_context_chars)
  - Exponential backoff retry for network errors
  - Stores up to 50 turns per thread, trims to budget at prompt time
...
Write-Host "  Feishu ↔ Claude Bridge v1.2 — Setup"         -ForegroundColor Cyan
Write-Host "=============================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    Write-Warn "Claude CLI not found. Install with: npm install -g @anthropic-ai/claude-code"
